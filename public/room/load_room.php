                        ...
                        <div class="card h-100 shadow-sm listing-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="fw-bold text-success">LKR <?= number_format($room['price_per_month'], 2) ?>/mo</span>
                                    <a href="<?= app_url('public/room/details.php?id=' . $room['room_id']) ?>" class="btn btn-sm btn-outline-primary">View</a>
                                </div>
                            </div>
                        </div>
                    </div>
