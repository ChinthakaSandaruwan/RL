...
if (isset($_GET['id'])) {
    ...
    $stmt = $pdo->prepare("SELECT * FROM user WHERE user_id = ? AND role_id = 4");
...
<head>
    <meta charset="UTF-8">
    <title>Change Customer Status - Rental Lanka</title>
            ...
            <div class="col-md-6 col-lg-5">
                <div class="card shadow">
                    <div class="card-header bg-white py-3">
                        <h5 class="mb-0 fw-bold">Change Customer Status</h5>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="status_id" class="form-select status-select">
                                    <?php foreach($statuses as $st): ?>
                                        <option value="<?= $st['status_id'] ?>" <?= $targetUser['status_id'] == $st['status_id'] ? 'selected' : '' ?>>
                            ...
                            <div class="d-flex gap-2">
                                <a href="../read/read_customer.php" class="btn btn-outline-secondary flex-grow-1">Cancel</a>
